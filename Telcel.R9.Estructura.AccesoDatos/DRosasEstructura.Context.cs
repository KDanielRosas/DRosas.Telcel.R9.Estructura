...
namespace Telcel.R9.Estructura.AccesoDatos
{
    ...
    public partial class DRosasEstructuraEntities : DbContext
    {
        public DRosasEstructuraEntities()
            : base("name=DRosasEstructuraEntities")
        {
        }
        ...
        public virtual ObjectResult<EmpleadoGetAll_Result> EmpleadoGetAll(string nombre, Nullable<int> puestoID, Nullable<int> departamentoID)
        {
            var nombreParameter = nombre != null ?
                new ObjectParameter("Nombre", nombre) :
                new ObjectParameter("Nombre", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<EmpleadoGetAll_Result>("EmpleadoGetAll", nombreParameter, puestoIDParameter, departamentoIDParameter);
        }
        ...
        public virtual int EmpleadoUpdate(Nullable<int> empleadoID, string nombre, Nullable<int> puestoID, Nullable<int> departamentoID)
        {
            var empleadoIDParameter = empleadoID.HasValue ?
                new ObjectParameter("EmpleadoID", empleadoID) :
                new ObjectParameter("EmpleadoID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("EmpleadoUpdate", empleadoIDParameter, nombreParameter, puestoIDParameter, departamentoIDParameter);
        }
    }
}
